...
def test(args, model, device, test_loader, epoch, hpt):
    ...
    # If using a DistributedSampler, the test dataset might be split across processes.
    # Here, we simply compute metrics per process.
...
def main():
    ...
    # Disable download progress output
    utils.gen_bar_updater = lambda: lambda x: None
